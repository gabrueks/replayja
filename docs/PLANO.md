...
| B7 | Grupos: CRUD, convite por link/e-mail, sessões semanais, resumo semanal | ✅ grupos v2 em produção (editar, sair/remover, revogar/expirar convite, cron do resumo com `CRON_SECRET`, descadastro RFC 8058, `.ics`) | ✅ | B5 |
